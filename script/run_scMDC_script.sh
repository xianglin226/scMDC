...
--embedding_file --prediction_file --filter
...
--embedding_file --prediction_file --filter --f1 2000 --f2 2000 -el 256 128 64 -dl1 64 128 256 -dl2 64 128 256 -fi1 0.005 -fi2 0.005 -signma2 2.5 -tau .1
